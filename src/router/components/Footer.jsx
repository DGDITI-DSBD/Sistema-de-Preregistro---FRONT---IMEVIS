        ...
        <div>
            <footer class="text-white shadow-xl bg-colorPrimario">
                <div class="w-full max-w-screen-2xl mx-auto md:py-5">
                    ...
                    <span class="block text-sm text-white sm:text-center dark:text-gray-400 text-center">© 2025 - <a href="https://flowbite.com/" class="hover:underline">Dirección General de Desarrollo Instutucional y Tecnologías de la Información</a></span>
                </div>
            </footer>
